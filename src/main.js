...
$(document).ready(function(){
  ...
  $("form").submit(function(event){
    ...
    console.log(newAge.planetCalc());
    console.log(newAge.all[0]);
    console.log(newAge.yearsLeft[0]);
    ...
    // && Math.sign(newAge.yearsLeft[0] === -1)) 
    // for Mercury selection
    if (userSelection === "mercury") {
    ...
    // }
    // // for Venus selection 
    // if (userSelection === "venus" && Math.sign(newAge.yearsLeft[1] === 1 )) {
    ...
    // // for Mars selection 
    // if (userSelection === "mars" && Math.sign(newAge.yearsLeft[2] === 1 )) {
    ...
    // if (userSelection === "jupiter" && Math.sign(newAge.yearsLeft[3] === 1 )) {
